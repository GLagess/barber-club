  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <Suspense fallback={<div className="space-y-4 animate-pulse"><div className="h-10 rounded-lg bg-dark-card"/><div className="h-10 rounded-lg bg-dark-card"/><div className="h-10 rounded-lg bg-gold/30"/></div>}>
          <SignInForm />
        </Suspense>
